...
import sty from "./PlasmicButton.module.css"; // plasmic-import: jbgHgwnt8sB/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: kx0tkdlSYLH/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: 5wUAFl0GCtC/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__jgdl0)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__hKn8X)}
                role={"img"}
              />
            ),
